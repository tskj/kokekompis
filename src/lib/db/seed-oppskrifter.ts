...
// Oppskriftsinnholdet som seedes inn i utviklingsbasen — og som eksempelboka på den utloggede
// forsiden serverer (src/lib/eksempelbok.ts). Ren data, ingen sideeffekter.
export const skillingsboller: RecipeContent = {
  info: {
...
export const sjokoladekake: RecipeContent = {
  info: {
...
export const pannekaker: RecipeContent = {
  info: {
...
export const focaccia: RecipeContent = {
  info: {
...
export const fiskesuppe: RecipeContent = {
  info: {
    porsjoner: { antall: 4, benevnelse: 'porsjoner' },
    kanSkaleres: true,
    aktivTidMinutter: 35,
...
export const vaniljekrem: RecipeContent = {
  info: {
...
export const skoleboller: RecipeContent = {
  info: {
