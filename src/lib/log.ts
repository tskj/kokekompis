...
// EAV-shaped structured event logger — the same shape the sister project heartbeet uses.
//
...
// into routes/actions (e.g. RECIPE_CREATED: ":recipe/created"). The ones below are the generic
// lifecycle attributes the logger machinery itself emits, plus an auth example.
export const Attr = {
...
// fact about a different entity — e.g. a recipe id). Both record one fact.
//
